...
- (IBAction)createBusinessNote:(id)sender {
  ...
  [noteStore
      listBusinessNotebooksWithSuccess:^(NSArray *linkedNotebooks) {
        if (linkedNotebooks.count > 0) {
          ...
          NSString *noteContent = [NSString
              stringWithFormat:
                  @"<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
                   ...
                   "%@"
                   "</en-note>",
                  [ENMLUtility mediaTagWithDataHash:dataHash
                                               mime:@"image/png"]];
          NSMutableArray *resources =
              [NSMutableArray arrayWithArray:@[ resource ]];
          EDAMNote *newNote =
              [[EDAMNote alloc] initWithGuid:nil
          ...
          [noteStore createNote:newNote
              inBusinessNotebook:businessNotebook
